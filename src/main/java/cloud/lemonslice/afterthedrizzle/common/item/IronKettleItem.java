...
public class IronKettleItem extends TeapotItem
{
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
    {
        ...
        if (nbt != null)
        {
            ...
            {
                tooltip.add(new TranslationTextComponent("info.afterthedrizzle.tooltip.iron_kettle.to_boil").applyTextStyles(TextFormatting.GRAY));
            }
        }
        else
        {
            tooltip.add(new TranslationTextComponent("info.afterthedrizzle.tooltip.iron_kettle.to_fill").applyTextStyles(TextFormatting.GRAY));
        }
