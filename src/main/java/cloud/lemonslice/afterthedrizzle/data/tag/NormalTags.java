package cloud.lemonslice.afterthedrizzle.data.tag;
...
public final class NormalTags
{
    public static class Items
    {
        ...
        public final static Tag<Item> SPRING = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/spring"));
        public final static Tag<Item> SUMMER = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/summer"));
        public final static Tag<Item> AUTUMN = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/autumn"));
        public final static Tag<Item> WINTER = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/winter"));
        public final static Tag<Item> SP_SU = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/spring_summer"));
        public final static Tag<Item> SP_AU = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/spring_autumn"));
        public final static Tag<Item> SP_WI = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/spring_winter"));
        public final static Tag<Item> SU_AU = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/summer_autumn"));
        public final static Tag<Item> SU_WI = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/summer_winter"));
        public final static Tag<Item> AU_WI = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/autumn_winter"));
        public final static Tag<Item> SP_SU_AU = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/spring_summer_autumn"));
        public final static Tag<Item> SP_SU_WI = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/spring_summer_winter"));
        public final static Tag<Item> SP_AU_WI = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/spring_autumn_winter"));
        public final static Tag<Item> SU_AU_WI = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/summer_autumn_winter"));
        public final static Tag<Item> ALL_SEASONS = new ItemTags.Wrapper(new ResourceLocation("afterthedrizzle:crops/all_seasons"));
