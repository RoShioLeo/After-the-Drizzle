...
//        this.drawString(mc.fontRenderer, String.valueOf(env), screenWidth / 2 - mc.fontRenderer.getStringWidth(String.valueOf(env)) / 2, 12, 4210752);
        ...
        blit((ClientConfig.GUI.playerTemperatureX.get() + 33), screenHeight - ClientConfig.GUI.playerTemperatureY.get(), cold * 9, 30, 9, 9);
        blit((ClientConfig.GUI.playerTemperatureX.get() + 43), screenHeight - ClientConfig.GUI.playerTemperatureY.get(), heat * 9, 39, 9, 9);
