...
public final class BlocksRegistry extends RegistryModule
{
    ...
    public static final BlockItem BAMBOO_CHAIR_ITEM = new ItemBlock(BAMBOO_CHAIR, BambooChairBlock.getItemProperties());

    public static final Block BAMBOO_TABLE = new BambooTableBlock();
    public static final BlockItem BAMBOO_TABLE_ITEM = new ItemBlock(BAMBOO_TABLE, BambooTableBlock.getItemProperties());

    public static final Block BAMBOO_LANTERN = new BambooLanternBlock();
    public static final BlockItem BAMBOO_LANTERN_ITEM = new ItemBlock(BAMBOO_LANTERN, BambooLanternBlock.getItemProperties());

    public static final Block BAMBOO_DOOR = new BambooDoorBlock("bamboo_door");
    public static final BlockItem BAMBOO_DOOR_ITEM = new ItemBlock(BAMBOO_DOOR, BambooDoorBlock.getItemProperties());

    public static final Block BAMBOO_GLASS_DOOR = new BambooDoorBlock("bamboo_glass_door");
    public static final BlockItem BAMBOO_GLASS_DOOR_ITEM = new ItemBlock(BAMBOO_GLASS_DOOR, BambooDoorBlock.getItemProperties());
}
