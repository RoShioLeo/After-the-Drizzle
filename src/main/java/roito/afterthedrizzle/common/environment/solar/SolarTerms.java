...
import roito.afterthedrizzle.client.color.season.SolarTermColors;
...
public enum SolarTerms
{
    ...
    GREATER_COLD(-0.45F, 10000);

    private final float temperature;
    private final int dayTime;

    SolarTerms(float temperature, int dayTime)
    {
