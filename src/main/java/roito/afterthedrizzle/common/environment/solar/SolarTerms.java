...
public enum SolarTerms
{
    ...
    LESSER_HEAT(ColorHelper.simplyMixColor(0x1d953f, 0.6F, 0x8c531b, 0.4F), 0.8F, 0xffe600, 0.3F, 0.2F, 14500),
    GREATER_HEAT(ColorHelper.simplyMixColor(0x1d953f, 0.5F, 0x8c531b, 0.5F), 0.8F, 0xffe600, 0.5F, 0.25F, 14000),

    // Autumn Solar Terms
    BEGINNING_OF_AUTUMN(ColorHelper.simplyMixColor(0x1d953f, 0.38F, 0x8c531b, 0.62F), 0.75F, 0xffe600, 0.7F, 0.15F, 13500),
    END_OF_HEAT(ColorHelper.simplyMixColor(0x1d953f, 0.25F, 0x8c531b, 0.75F), 0.7F, 0xffe600, 0.8F, 0.1F, 13000),
    WHITE_DEW(ColorHelper.simplyMixColor(0x1d953f, 0.12F, 0x8c531b, 0.87F), 0.7F, 0xffe600, 0.9F, 0.05F, 12500),
    AUTUMNAL_EQUINOX(0x8c531b, 0.6F, 0xffe600, 0.9F, 0.0F, 12000),
    COLD_DEW(0x8c531b, 0.48F, 0xffe600, 0.8F, -0.1F, 11500),
    FIRST_FROST(0x8c531b, 0.35F, 0xffe600, 0.7F, -0.2F, 11000),

    // Winter Solar Terms
    BEGINNING_OF_WINTER(0x8c531b, 0.22F, 0xffe600, 0.5F, -0.3F, 10500),
    LIGHT_SNOW(0x8c531b, 0.1F, 0xffe600, 0.3F, -0.35F, 10000),
    HEAVY_SNOW(0x0, 0.0F, -0.35F, 9500),
    WINTER_SOLSTICE(0x0, 0.0F, -0.4F, 9000),
    LESSER_COLD(0x0, 0.0F, -0.45F, 9500),
    GREATER_COLD(0x0, 0.0F, -0.45F, 10000);
    ...
    SolarTerms(int mixColorIn, float alpha, int birchColor, float birchAlpha, float temperature, int dayTime)
    {
