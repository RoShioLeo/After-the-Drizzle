...
public class FluidsRegistry
{
    ...
    public static final RegistryObject<BucketItem> SUGARY_WATER_BUCKET = ITEMS.register("sugary_water_bucket", () -> new BucketItem(FluidsRegistry.SUGARY_WATER_STILL, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(AfterTheDrizzle.GROUP_CRAFT)));
    ...
    public static final ForgeFlowingFluid.Properties SUGARY_WATER_PROPERTIES = new ForgeFlowingFluid.Properties(SUGARY_WATER_STILL, SUGARY_WATER_FLOW, FluidAttributes.builder(WATER_STILL_TEXTURE, WATER_FLOW_TEXTURE).color(0xFF5AB4E6)).bucket(SUGARY_WATER_BUCKET).block(() -> BlocksRegistry.SUGARY_WATER).explosionResistance(100F);
}
