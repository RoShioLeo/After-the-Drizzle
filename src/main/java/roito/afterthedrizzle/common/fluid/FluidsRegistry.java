...
public class FluidsRegistry
{
    ...
    public static final RegistryObject<FlowingFluidBlock> WEAK_GREEN_TEA = BLOCKS.register("weak_green_tea", () -> new NormalFlowingFluidBlock(FluidsRegistry.WEAK_GREEN_TEA_STILL, NormalFlowingFluidBlock.getProperties().noDrops()));
    public static final RegistryObject<FlowingFluidBlock> WEAK_BLACK_TEA = BLOCKS.register("weak_black_tea", () -> new NormalFlowingFluidBlock(FluidsRegistry.WEAK_BLACK_TEA_STILL, NormalFlowingFluidBlock.getProperties().noDrops()));
    ...
    public static final RegistryObject<FlowingFluidBlock> STRONG_GREEN_TEA = BLOCKS.register("strong_green_tea", () -> new NormalFlowingFluidBlock(FluidsRegistry.STRONG_GREEN_TEA_STILL, NormalFlowingFluidBlock.getProperties().noDrops()));
    public static final RegistryObject<FlowingFluidBlock> STRONG_BLACK_TEA = BLOCKS.register("strong_black_tea", () -> new NormalFlowingFluidBlock(FluidsRegistry.STRONG_BLACK_TEA_STILL, NormalFlowingFluidBlock.getProperties().noDrops()));
