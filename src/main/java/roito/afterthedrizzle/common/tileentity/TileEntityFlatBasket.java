...
{
    private ItemStackHandler containerInventory = new ItemStackHandler();
    ...
    private SingleInRecipe currentRecipe = new SingleInRecipe(NonNullListHelper.createNonNullList(ItemStack.EMPTY), ItemStack.EMPTY);
