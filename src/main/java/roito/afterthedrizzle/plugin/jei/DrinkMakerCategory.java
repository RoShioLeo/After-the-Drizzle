...
import static roito.afterthedrizzle.plugin.jei.JEICompat.DRINK_MAKER;
...
public class DrinkMakerCategory implements IRecipeCategory<DrinkRecipeInput>
{
    ...
    {
        return guiHelper.createDrawable(new ResourceLocation(MODID, "textures/gui/jei/recipes.png"), 0, 0, 149, 75);
    }
